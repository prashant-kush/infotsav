...
{
	return(
		<div className="loader" style={{visibility:visibility}}>
			<svg version="1.2" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="170.49px" height="177px" viewBox="0 0 170.49 177" overflow="inherit" xmlSpace="preserve">
